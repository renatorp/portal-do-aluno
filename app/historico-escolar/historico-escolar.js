...
var HistoricoEscolarPortal = (function () {
    function HistoricoEscolarPortal(alunoService) {
        var _this = this;
        this.alunoService = alunoService;
        this.listaHistorico = [];
        this.alunoService.getHistoricoEscolar().then(function (listaHistorico) { return _this.listaHistorico = listaHistorico; });
    }
